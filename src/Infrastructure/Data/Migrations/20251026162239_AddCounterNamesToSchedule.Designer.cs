...
namespace BusReservationSystem.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251026162239_AddCounterNamesToSchedule")]
    partial class AddCounterNamesToSchedule
    {
            ...
            modelBuilder.Entity("BusReservationSystem.Domain.Entities.BusSchedule", b =>
                {
                    ...
                    b.Property<string>("ArrivalCounter")
                        .IsRequired()
                        .HasMaxLength(200)
                    ...
                    b.Property<string>("StartingCounter")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
